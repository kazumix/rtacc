...
@LibVersion_0x0701 = weak_odr dso_local global i32 1, comdat, align 4
...
2:                                                ; preds = %2, %0
  %3 = call i32 @hugeplc_ascii2()
  %4 = call zeroext i8 @RtSleepEx(i32 noundef 10)
  br label %2
}

declare dso_local i32 @hugeplc_ascii2() #1

declare dso_local zeroext i8 @RtSleepEx(i32 noundef) #1
