; ModuleID = 'examples\GEil\main.c'
source_filename = "examples\\GEil\\main.c"
...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  tail call void @GEtest_slots_init() #2
  br label %1

1:                                                ; preds = %1, %0
  %2 = tail call i32 @GEtest() #2
  %3 = tail call zeroext i8 @RtSleepEx(i32 noundef 1) #2
  br label %1
}

declare dso_local void @GEtest_slots_init() local_unnamed_addr #1

declare dso_local i32 @GEtest() local_unnamed_addr #1
...
!1 = !DIFile(filename: "examples\\GEil\\main.c", directory: "D:\\work\\rtacc")
