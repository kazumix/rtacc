...
define i1 @NotBool(i1 %x) local_unnamed_addr #2 {
entry:
  %b1 = xor i1 %x, true
  ret i1 %b1
}
...
!2 = !{!"clang version 22.1.1 (https://github.com/llvm/llvm-project fef02d48c08db859ef83f84232ed78bd9d1c323a)"}
