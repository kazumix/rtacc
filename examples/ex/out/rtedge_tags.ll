; ModuleID = 'd:\work\rtacc\examples\ex\rtedge_tags.c'
source_filename = "d:\\work\\rtacc\\examples\\ex\\rtedge_tags.c"
...
$"??_C@_07GBHPHJEE@INT?$CDANS?$AA@" = comdat any

@il_rtedge_tag_count = internal unnamed_addr global i32 0, align 4
@k_ex_rtedge_scalar_specs = internal unnamed_addr constant [3 x ptr] [ptr @"??_C@_08CDIBBFAJ@BOOL?$CDSW1?$AA@", ptr @"??_C@_08IKMEGMK@BOOL?$CDSW2?$AA@", ptr @"??_C@_07GBHPHJEE@INT?$CDANS?$AA@"], align 4
...
@"??_C@_07GBHPHJEE@INT?$CDANS?$AA@" = linkonce_odr dso_local unnamed_addr constant [8 x i8] c"INT#ANS\00", comdat, align 1
...
5:                                                ; preds = %2
  ...
  %7 = getelementptr inbounds nuw [3 x ptr], ptr @k_ex_rtedge_scalar_specs, i32 0, i32 %6
...
!1 = !DIFile(filename: "d:\\work\\rtacc\\examples\\ex\\rtedge_tags.c", directory: "D:\\work\\rtacc\\examples\\ex")
