; ModuleID = 'examples\IL\il_rtedge_egapi.c'
source_filename = "examples\\IL\\il_rtedge_egapi.c"
...
105:                                              ; preds = %83
  ...
  %107 = tail call i32 @EgTagCreateEx(ptr noundef nonnull %106, i16 noundef zeroext %84, ptr noundef nonnull @"??_C@_00CNPNBAHC@?$AA@", ptr noundef nonnull @"??_C@_00CNPNBAHC@?$AA@") #8
...
!1 = !DIFile(filename: "examples\\IL\\il_rtedge_egapi.c", directory: "D:\\work\\rtacc")
