...
static const char *const k_ex_rtedge_scalar_specs[] = {
	"BOOL#SW1",
	"BOOL#SW2",
	"INT#ANS",
};
...
void IlRtedgeTags_Init(void)
{
	...
	for (i = 0; i < sizeof(k_ex_rtedge_scalar_specs) / sizeof(k_ex_rtedge_scalar_specs[0]); i++)
		il_rtedge_apply_instruction_spec(k_ex_rtedge_scalar_specs[i]);
