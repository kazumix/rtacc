...
define dso_local noundef i32 @main(i32 noundef %0, ptr noundef readnone captures(none) %1) local_unnamed_addr #0 {
  %3 = tail call zeroext i8 @RtSleep(i32 noundef 1000) #3
  %4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @"??_C@_0BB@IHCNNFND@Hello?5rtacc?$CB?5?$CFd?6?$AA@", i32 noundef 0)
  %5 = tail call zeroext i8 @RtSleep(i32 noundef 1000) #3
  %6 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @"??_C@_0BB@IHCNNFND@Hello?5rtacc?$CB?5?$CFd?6?$AA@", i32 noundef 1)
  %7 = tail call zeroext i8 @RtSleep(i32 noundef 1000) #3
  %8 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @"??_C@_0BB@IHCNNFND@Hello?5rtacc?$CB?5?$CFd?6?$AA@", i32 noundef 2)
  %9 = tail call zeroext i8 @RtSleep(i32 noundef 1000) #3
  %10 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @"??_C@_0BB@IHCNNFND@Hello?5rtacc?$CB?5?$CFd?6?$AA@", i32 noundef 3)
  %11 = tail call zeroext i8 @RtSleep(i32 noundef 1000) #3
  %12 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @"??_C@_0BB@IHCNNFND@Hello?5rtacc?$CB?5?$CFd?6?$AA@", i32 noundef 4)
  ret i32 0
}
...
!1 = !DIFile(filename: "main.c", directory: "D:\\work\\rtacc\\examples\\hello")
