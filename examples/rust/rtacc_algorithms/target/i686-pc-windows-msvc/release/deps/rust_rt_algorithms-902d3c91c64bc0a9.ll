; ModuleID = 'rust_rt_algorithms.f82c848ede4bbb47-cgu.0'
source_filename = "rust_rt_algorithms.f82c848ede4bbb47-cgu.0"
...
@alloc_5d231b875d4ca813da63a117cabf1a69 = private unnamed_addr constant [24 x i8] c"sqrt(2)*1e6 (libm): %d\0A\00", align 1
@alloc_8109a7e01150c96d0bf8d9504bc28a98 = private unnamed_addr constant [27 x i8] c"micromath sqrt(2)*1e6: %d\0A\00", align 1
...
@str.6 = private unnamed_addr constant [25 x i8] c"rust_rt_algorithms: FAIL\00", align 1
@str.7 = private unnamed_addr constant [62 x i8] c"rust_rt_algorithms: PASS (heapless + libm + micromath approx)\00", align 1
...
define noundef range(i32 0, 2) i32 @main(i32 noundef %_argc, ptr noundef readnone captures(none) %_argv) unnamed_addr #1 personality ptr @__CxxFrameHandler3 {
bb2.i.i.3.i.preheader:
  ...
  %storemerge.lcssa.i.i.3.i.ph.sroa.gep14 = getelementptr inbounds nuw i8, ptr %heap.i, i32 4
...
bb6.3.i:                                          ; preds = %bb6.i.i.3.i.1, %bb6.i.i.3.i, %bb2.i.i.3.i.preheader
  %storemerge.lcssa.i.i.3.i.ph.sroa.phi = phi ptr [ %storemerge.lcssa.i.i.3.i.ph.sroa.gep, %bb2.i.i.3.i.preheader ], [ %storemerge.lcssa.i.i.3.i.ph.sroa.gep14, %bb6.i.i.3.i ], [ %heap.i, %bb6.i.i.3.i.1 ]
...
bb4.i:                                            ; preds = %bb6.6.i, %bb6.5.i, %bb6.4.i, %bb6.3.i
  ...
  br label %_ZN18rust_rt_algorithms13run_heap_demo17h953ca05ae413df46E.exit

bb7.i:                                            ; preds = %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E.exit50.i", %bb6.7.i
  %iter1.sroa.8.0.i = phi i32 [ 0, %bb6.7.i ], [ %_8.0.i.i, %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E.exit50.i" ]
  %iter1.sroa.0.0.idx.i = phi i32 [ 0, %bb6.7.i ], [ %iter1.sroa.0.0.add.i, %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E.exit50.i" ]
...
bb24.i:                                           ; preds = %bb9.i
  ...
  %18 = icmp eq i32 %16, 0
  br i1 %18, label %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E.exit50.i", label %bb2.i10.i
...
bb2.i10.i:                                        ; preds = %bb24.i
  ...
  br i1 %_1011.i.not.i12.i, label %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$19sift_down_to_bottom17h25e808b2afe512c3E.exit.i36.i", label %bb2.i.i13.i
...
bb2.i.i.i28.i:                                    ; preds = %bb6.i.i.i40.i, %bb2.i.preheader.i.i24.i
  ...
  br i1 %_31.not.i.i.i35.i, label %bb6.i.i.i40.i, label %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$19sift_down_to_bottom17h25e808b2afe512c3E.exit.i36.i"
...
bb6.i.i.i40.i:                                    ; preds = %bb2.i.i.i28.i
  ...
  br i1 %_6.not.i.i.i42.i, label %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$19sift_down_to_bottom17h25e808b2afe512c3E.exit.i36.i", label %bb2.i.i.i28.i
...
"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$19sift_down_to_bottom17h25e808b2afe512c3E.exit.i36.i": ; preds = %bb6.i.i.i40.i, %bb2.i.i.i28.i, %bb2.i10.i
  ...
  br label %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E.exit50.i"

"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E.exit50.i": ; preds = %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$19sift_down_to_bottom17h25e808b2afe512c3E.exit.i36.i", %bb24.i
  %item.sroa.0.0.i39.i = phi i32 [ %17, %bb24.i ], [ %item.sroa.0.0.copyload.i11.i, %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$19sift_down_to_bottom17h25e808b2afe512c3E.exit.i36.i" ]
  %_4.i51.i = tail call noundef i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @alloc_9eb6ad1bb2761d7967bbb21aee962b44, i32 noundef %iter1.sroa.8.0.i, i32 noundef %item.sroa.0.0.i39.i) #9
...
bb13.i:                                           ; preds = %"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E.exit50.i"
  %_4.i52.i = tail call noundef i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @alloc_5417d29f1a01a8b6dc8cee7e1e1cab8e, i32 noundef %item.sroa.0.0.i39.i, i32 noundef %exp.i) #9
  br label %bb17.i

_ZN18rust_rt_algorithms13run_heap_demo17h953ca05ae413df46E.exit: ; preds = %bb4.i, %bb26.i, %bb17.i
  %_0.sroa.0.1.i = phi i1 [ %.not3.i, %bb26.i ], [ false, %bb17.i ], [ false, %bb4.i ]
  call void @llvm.lifetime.end.p0(i64 68, ptr nonnull %heap.i)
  %21 = tail call float asm inteldialect "sqrtss ${0:x}, ${0:x}", "=&x,0,~{dirflag},~{fpsr},~{flags}"(float 2.000000e+00) #10, !srcloc !47
  %_6.i = fmul float %21, 1.000000e+06
  %_5.i = tail call i32 @llvm.fptosi.sat.i32.f32(float %_6.i)
  %_3.i.i = tail call noundef i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @alloc_5d231b875d4ca813da63a117cabf1a69, i32 noundef %_5.i) #9
  %_2.i = fadd float %21, 0xBFF6A09E60000000
  %22 = tail call float @llvm.fabs.f32(float %_2.i)
  %_3.i3.i = tail call noundef i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @alloc_8109a7e01150c96d0bf8d9504bc28a98, i32 noundef 1500000) #9
  %_0.i = fcmp olt float %22, 0x3F1A36E2E0000000
  %brmerge.demorgan = and i1 %_0.sroa.0.1.i, %_0.i
  %str.7.str.6 = select i1 %brmerge.demorgan, ptr @str.7, ptr @str.6
  %not.brmerge.demorgan = xor i1 %brmerge.demorgan, true
  %. = zext i1 %not.brmerge.demorgan to i32
  %puts3 = tail call i32 @puts(ptr nonnull dereferenceable(1) %str.7.str.6)
  ret i32 %.
}
...
declare noundef i32 @printf(ptr noundef readonly captures(none), ...) unnamed_addr #4
...
attributes #4 = { nofree nounwind uwtable "target-cpu"="pentium4" }
...
!2 = !{!3}
!3 = distinct !{!3, !4, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$4push17h6931c2fd6c8eeacdE: %self"}
!4 = distinct !{!4, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$4push17h6931c2fd6c8eeacdE"}
!5 = !{!6, !3}
!6 = distinct !{!6, !7, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$7sift_up17hba2089570c9f9f06E: %self"}
!7 = distinct !{!7, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$7sift_up17hba2089570c9f9f06E"}
!8 = !{}
!9 = !{!10, !12}
!10 = distinct !{!10, !11, !"_ZN78_$LT$heapless..binary_heap..Hole$LT$T$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6278ab51a1592d82E: %self"}
!11 = distinct !{!11, !"_ZN78_$LT$heapless..binary_heap..Hole$LT$T$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6278ab51a1592d82E"}
!12 = distinct !{!12, !13, !"_ZN4core3ptr59drop_in_place$LT$heapless..binary_heap..Hole$LT$i32$GT$$GT$17hc21947449096776aE: %_1"}
!13 = distinct !{!13, !"_ZN4core3ptr59drop_in_place$LT$heapless..binary_heap..Hole$LT$i32$GT$$GT$17hc21947449096776aE"}
!14 = !{!15}
!15 = distinct !{!15, !16, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E: %self"}
!16 = distinct !{!16, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E"}
!17 = !{!18, !15}
!18 = distinct !{!18, !19, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$19sift_down_to_bottom17h25e808b2afe512c3E: %self"}
!19 = distinct !{!19, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$19sift_down_to_bottom17h25e808b2afe512c3E"}
!20 = !{!21, !23}
!21 = distinct !{!21, !22, !"_ZN78_$LT$heapless..binary_heap..Hole$LT$T$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6278ab51a1592d82E: %self"}
!22 = distinct !{!22, !"_ZN78_$LT$heapless..binary_heap..Hole$LT$T$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6278ab51a1592d82E"}
!23 = distinct !{!23, !24, !"_ZN4core3ptr59drop_in_place$LT$heapless..binary_heap..Hole$LT$i32$GT$$GT$17hc21947449096776aE: %_1"}
!24 = distinct !{!24, !"_ZN4core3ptr59drop_in_place$LT$heapless..binary_heap..Hole$LT$i32$GT$$GT$17hc21947449096776aE"}
!25 = !{!26, !18, !15}
!26 = distinct !{!26, !27, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$7sift_up17hba2089570c9f9f06E: %self"}
!27 = distinct !{!27, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$7sift_up17hba2089570c9f9f06E"}
!28 = !{!29}
!29 = distinct !{!29, !30, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E: %self"}
!30 = distinct !{!30, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$13pop_unchecked17h67b037f6d069bcc3E"}
!31 = !{!32, !29}
!32 = distinct !{!32, !33, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$19sift_down_to_bottom17h25e808b2afe512c3E: %self"}
!33 = distinct !{!33, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$19sift_down_to_bottom17h25e808b2afe512c3E"}
!34 = !{!35, !37}
!35 = distinct !{!35, !36, !"_ZN78_$LT$heapless..binary_heap..Hole$LT$T$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6278ab51a1592d82E: %self"}
!36 = distinct !{!36, !"_ZN78_$LT$heapless..binary_heap..Hole$LT$T$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6278ab51a1592d82E"}
!37 = distinct !{!37, !38, !"_ZN4core3ptr59drop_in_place$LT$heapless..binary_heap..Hole$LT$i32$GT$$GT$17hc21947449096776aE: %_1"}
!38 = distinct !{!38, !"_ZN4core3ptr59drop_in_place$LT$heapless..binary_heap..Hole$LT$i32$GT$$GT$17hc21947449096776aE"}
!39 = !{!40, !32, !29}
!40 = distinct !{!40, !41, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$7sift_up17hba2089570c9f9f06E: %self"}
!41 = distinct !{!41, !"_ZN8heapless11binary_heap27BinaryHeap$LT$T$C$K$C$_$GT$7sift_up17hba2089570c9f9f06E"}
!42 = !{!43, !45}
!43 = distinct !{!43, !44, !"_ZN78_$LT$heapless..binary_heap..Hole$LT$T$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6278ab51a1592d82E: %self"}
!44 = distinct !{!44, !"_ZN78_$LT$heapless..binary_heap..Hole$LT$T$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h6278ab51a1592d82E"}
!45 = distinct !{!45, !46, !"_ZN4core3ptr59drop_in_place$LT$heapless..binary_heap..Hole$LT$i32$GT$$GT$17hc21947449096776aE: %_1"}
!46 = distinct !{!46, !"_ZN4core3ptr59drop_in_place$LT$heapless..binary_heap..Hole$LT$i32$GT$$GT$17hc21947449096776aE"}
!47 = !{i64 11827004201108618}
