; ModuleID = 'D:\work\rtacc\examples\EQtest\main.c'
source_filename = "D:\\work\\rtacc\\examples\\EQtest\\main.c"
...
1:                                                ; preds = %1, %0
  %2 = tail call i32 @EQtest() #2
  %3 = tail call zeroext i8 @RtSleepEx(i32 noundef 1) #2
  br label %1
}

declare dso_local i32 @EQtest() local_unnamed_addr #1
...
!1 = !DIFile(filename: "D:\\work\\rtacc\\examples\\EQtest\\main.c", directory: "D:\\work\\rtacc\\examples\\EQtest")
