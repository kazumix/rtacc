...
@il_slot_MsTick = external dso_local local_unnamed_addr global ptr, align 4
...
1:                                                ; preds = %1, %0
  tail call void @LED2Check() #2
  %2 = load ptr, ptr @il_slot_MsTick, align 4
  %3 = load i32, ptr %2, align 4
  %4 = add nsw i32 %3, 1
  store i32 %4, ptr %2, align 4
  %5 = tail call zeroext i8 @RtSleepEx(i32 noundef 1) #2
  br label %1
}

declare dso_local void @IlRtedgeTags_Init() local_unnamed_addr #1

declare dso_local void @LED2Check() local_unnamed_addr #1
...
!1 = !DIFile(filename: "main.c", directory: "D:\\work\\rtacc\\examples\\ST2")
