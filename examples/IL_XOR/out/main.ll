...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  ...
  %2 = tail call i32 @XOR_FUNC(i32 noundef 0, i32 noundef 0) #4
  %3 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @"??_C@_0M@CCDLDBPH@0?5?$FO?50?5?$DN?5?$CFd?6?$AA@", i32 noundef %2)
  %4 = tail call i32 @XOR_FUNC(i32 noundef 0, i32 noundef 1) #4
  %5 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @"??_C@_0M@OOJBDBGJ@0?5?$FO?51?5?$DN?5?$CFd?6?$AA@", i32 noundef %4)
  %6 = tail call i32 @XOR_FUNC(i32 noundef 1, i32 noundef 0) #4
  %7 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @"??_C@_0M@LJJOHNJI@1?5?$FO?50?5?$DN?5?$CFd?6?$AA@", i32 noundef %6)
  %8 = tail call i32 @XOR_FUNC(i32 noundef 1, i32 noundef 1) #4
  %9 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @"??_C@_0M@HFDEHNAG@1?5?$FO?51?5?$DN?5?$CFd?6?$AA@", i32 noundef %8)
  ret i32 0
}
...
declare dso_local i32 @XOR_FUNC(i32 noundef, i32 noundef) local_unnamed_addr #2
...
!1 = !DIFile(filename: "main.c", directory: "D:\\work\\rtacc\\examples\\IL_XOR")
